    ...
    <div class="col-md-3">
        ...
        <section class="panel">
            <header class="panel-heading">
                @if(isset($catePro))
                    {{getNameCategoryProduct($catePro)}}
            ...
            <div class="panel-body">
                <ul class="nav prod-cat">
                  @if(isset($cateParent) && isset($catePro))
                  @foreach(getCategoryValueToParentProduct($cateParent, $catePro) as $item)
                    <li>
                        <a href="{{route('filterCategory',['cateParent'=>$cateParent,'catePro'=>$catePro, 'cateValue'=>$item->id])}}" class="active"><i class="fa fa-angle-right"></i>{{$item->name}}</a>
                    </li>
                  @endforeach
                  @else
                    <li>
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form action="{{route('filter',['cateParent'=>$cateParent,'catePro'=>$catePro])}}" method="GET" role="form product-form">
