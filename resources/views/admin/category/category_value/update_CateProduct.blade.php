...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{route('admin.categories.postUpdateCategoryValueParent',['id'=>$category->id])}}" method="POST">
                    <div class="mb-3">
                        <label for="">Name</label>
                        <input type="text" name="name" class="form-control w-50" placeholder="Category Name..." autocomplete value="{{old("name") ?? $category->name}}">
                        @error('name')
