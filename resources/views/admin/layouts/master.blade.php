...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#CategoryParentProducts"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Category Parent Product</span>
                </a>
                <div id="CategoryParentProducts" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Orders:</h6>
                        <a class="collapse-item" href="{{route('admin.categories.getCategoryParentProduct')}}">Show List</a>
                        <a class="collapse-item" href="{{route('admin.categories.categoryParentProductAdd')}}">Add New</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
    ...
    <script src="{{asset('admins')}}/js/demo/chart-bar-demo.js"></script>
